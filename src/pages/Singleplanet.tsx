      ...
      {details === "overview" ? (
        ...
        >
          ...
          <div className="flex  font-bold text-[9px]  tracking-[1.929px] font-spartan mt-[40px] justify-between">
            <Link to={`/planet/${currentPlanet?.name}/overview`}>OVERVIEW</Link>
            <Link to={`/planet/${currentPlanet?.name}/structure`}>
              Structure
            </Link>
            <Link to={`/planet/${currentPlanet?.name}/surface`}>surface</Link>
          </div>
